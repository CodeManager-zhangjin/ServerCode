...
//	ImageDataNode_t *pBuf = pLinux;
//	
//	for(i = 0; i < nHeaderlen; i++)
//		crc32 = ((crc32) >> 8) ^ crc32tab[(pHeader[i]) ^ ((crc32) & 0x000000FF)];
//	while(pBuf != NULL)
//	{
//		for (i = 0; i < pBuf->wLen; i++)
//		{
//			crc32 = ((crc32) >> 8) ^ crc32tab[(pBuf->pBuf[i]) ^ ((crc32) & 0x000000FF)];
//		}
//		pBuf = pBuf->pNext;
//	}
//	
